...
const CARD_SVG = {
  ...
  2:  (s) => <svg viewBox="0 0 44 64"><rect width="44" height="64" rx="4" fill="#be123c"/><rect x="2" y="2" width="40" height="60" rx="3" fill="none" stroke="rgba(255,255,255,0.3)" strokeWidth="1"/><line x1="22" y1="10" x2="22" y2="32" stroke="white" strokeWidth="3"/><line x1="13" y1="18" x2="31" y2="18" stroke="white" strokeWidth="3"/><circle cx="22" cy="10" r="3" fill="white"/>{!s&&<text x="22" y="52" textAnchor="middle" fontSize="5.5" fill="white" fontWeight="bold">대주교</text>}<text x="3" y="9" fontSize="7" fill="white" fontWeight="bold">2</text><text x="41" y="58" fontSize="7" fill="white" fontWeight="bold" transform="rotate(180,41,62)">2</text></svg>,
  3:  (s) => <svg viewBox="0 0 44 64"><rect width="44" height="64" rx="4" fill="#dc2626"/><rect x="12" y="8" width="20" height="22" fill="rgba(255,255,255,0.9)" rx="1"/><rect x="8" y="28" width="28" height="4" fill="rgba(255,255,255,0.9)"/><rect x="15" y="2" width="5" height="8" fill="rgba(255,255,255,0.9)"/><rect x="24" y="2" width="5" height="8" fill="rgba(255,255,255,0.9)"/><rect x="18" y="16" width="8" height="14" fill="#dc2626"/>{!s&&<text x="22" y="52" textAnchor="middle" fontSize="5.5" fill="white" fontWeight="bold">귀족</text>}<text x="3" y="9" fontSize="7" fill="white" fontWeight="bold">3</text><text x="41" y="58" fontSize="7" fill="white" fontWeight="bold" transform="rotate(180,41,62)">3</text></svg>,
  4:  (s) => <svg viewBox="0 0 44 64"><rect width="44" height="64" rx="4" fill="#ea580c"/><circle cx="22" cy="17" r="7" fill="rgba(255,255,255,0.9)"/><path d="M12 32 Q22 24 32 32 L30 36 Q22 30 14 36 Z" fill="rgba(255,255,255,0.9)"/><circle cx="19" cy="15" r="1.5" fill="#ea580c"/><circle cx="25" cy="15" r="1.5" fill="#ea580c"/>{!s&&<text x="22" y="52" textAnchor="middle" fontSize="5.5" fill="white" fontWeight="bold">귀족부인</text>}<text x="3" y="9" fontSize="7" fill="white" fontWeight="bold">4</text><text x="41" y="58" fontSize="7" fill="white" fontWeight="bold" transform="rotate(180,41,62)">4</text></svg>,
  5:  (s) => <svg viewBox="0 0 44 64"><defs><linearGradient id="g5" x1="0%" y1="0%" x2="0%" y2="100%"><stop offset="0%" stopColor="#fbbf24"/><stop offset="100%" stopColor="#d97706"/></linearGradient></defs><rect width="44" height="64" rx="4" fill="url(#g5)"/><circle cx="22" cy="17" r="6" fill="rgba(0,0,0,0.2)"/><rect x="16" y="23" width="12" height="10" rx="2" fill="rgba(0,0,0,0.2)"/><rect x="14" y="10" width="16" height="4" rx="1" fill="rgba(0,0,0,0.25)"/>{!s&&<text x="22" y="52" textAnchor="middle" fontSize="5.5" fill="#7c2d12" fontWeight="bold">총리</text>}<text x="3" y="9" fontSize="7" fill="#7c2d12" fontWeight="bold">5</text><text x="41" y="58" fontSize="7" fill="#7c2d12" fontWeight="bold" transform="rotate(180,41,62)">5</text></svg>,
  6:  (s) => <svg viewBox="0 0 44 64"><rect width="44" height="64" rx="4" fill="#ca8a04"/><circle cx="22" cy="18" r="8" fill="rgba(255,255,255,0.15)" stroke="rgba(255,255,255,0.5)" strokeWidth="1"/><circle cx="22" cy="18" r="4" fill="rgba(255,255,255,0.9)"/><line x1="22" y1="8" x2="22" y2="28" stroke="rgba(255,255,255,0.4)" strokeWidth="1"/><line x1="12" y1="18" x2="32" y2="18" stroke="rgba(255,255,255,0.4)" strokeWidth="1"/>{!s&&<text x="22" y="52" textAnchor="middle" fontSize="5.5" fill="white" fontWeight="bold">점성술사</text>}<text x="3" y="9" fontSize="7" fill="white" fontWeight="bold">6</text><text x="41" y="58" fontSize="7" fill="white" fontWeight="bold" transform="rotate(180,41,62)">6</text></svg>,
  7:  (s) => <svg viewBox="0 0 44 64"><rect width="44" height="64" rx="4" fill="#a16207"/><line x1="22" y1="6" x2="22" y2="30" stroke="rgba(255,255,255,0.9)" strokeWidth="3" strokeLinecap="round"/><line x1="22" y1="6" x2="16" y2="14" stroke="rgba(255,255,255,0.9)" strokeWidth="2.5" strokeLinecap="round"/><line x1="22" y1="6" x2="28" y2="14" stroke="rgba(255,255,255,0.9)" strokeWidth="2.5" strokeLinecap="round"/><ellipse cx="22" cy="31" rx="5" ry="3" fill="rgba(255,255,255,0.7)"/>{!s&&<text x="22" y="52" textAnchor="middle" fontSize="5.5" fill="white" fontWeight="bold">기사</text>}<text x="3" y="9" fontSize="7" fill="white" fontWeight="bold">7</text><text x="41" y="58" fontSize="7" fill="white" fontWeight="bold" transform="rotate(180,41,62)">7</text></svg>,
  8:  (s) => <svg viewBox="0 0 44 64"><rect width="44" height="64" rx="4" fill="#94a3b8"/><circle cx="18" cy="16" r="4" fill="rgba(255,255,255,0.8)"/><line x1="18" y1="16" x2="30" y2="28" stroke="rgba(255,255,255,0.9)" strokeWidth="2"/><circle cx="30" cy="28" r="3" fill="rgba(255,255,255,0.6)" stroke="rgba(255,255,255,0.9)" strokeWidth="1"/>{!s&&<text x="22" y="52" textAnchor="middle" fontSize="5.5" fill="white" fontWeight="bold">재봉사</text>}<text x="3" y="9" fontSize="7" fill="white" fontWeight="bold">8</text><text x="41" y="58" fontSize="7" fill="white" fontWeight="bold" transform="rotate(180,41,62)">8</text></svg>,
  9:  (s) => <svg viewBox="0 0 44 64"><rect width="44" height="64" rx="4" fill="#78716c"/><rect x="10" y="24" width="24" height="8" rx="1" fill="rgba(255,255,255,0.7)"/><rect x="16" y="16" width="4" height="10" fill="rgba(255,255,255,0.9)"/><rect x="24" y="16" width="4" height="10" fill="rgba(255,255,255,0.9)"/><line x1="14" y1="12" x2="20" y2="16" stroke="rgba(255,255,255,0.7)" strokeWidth="2"/><line x1="30" y1="12" x2="24" y2="16" stroke="rgba(255,255,255,0.7)" strokeWidth="2"/>{!s&&<text x="22" y="52" textAnchor="middle" fontSize="5.5" fill="white" fontWeight="bold">농부</text>}<text x="3" y="9" fontSize="7" fill="white" fontWeight="bold">9</text><text x="41" y="58" fontSize="7" fill="white" fontWeight="bold" transform="rotate(180,41,62)">9</text></svg>,
  10: (s) => <svg viewBox="0 0 44 64"><rect width="44" height="64" rx="4" fill="#64748b"/><circle cx="22" cy="14" r="7" fill="rgba(255,255,255,0.8)"/><rect x="10" y="14" width="24" height="3" rx="1" fill="rgba(255,255,255,0.6)"/><ellipse cx="22" cy="22" rx="10" ry="3" fill="rgba(255,255,255,0.4)"/>{!s&&<text x="22" y="52" textAnchor="middle" fontSize="5.5" fill="white" fontWeight="bold">요리사</text>}<text x="3" y="9" fontSize="7" fill="white" fontWeight="bold">10</text><text x="41" y="58" fontSize="7" fill="white" fontWeight="bold" transform="rotate(180,41,62)">10</text></svg>,
  11: (s) => <svg viewBox="0 0 44 64"><rect width="44" height="64" rx="4" fill="#475569"/><circle cx="16" cy="15" r="4" fill="rgba(255,255,255,0.5)" stroke="rgba(255,255,255,0.7)" strokeWidth="1.5"/><circle cx="28" cy="15" r="4" fill="rgba(255,255,255,0.5)" stroke="rgba(255,255,255,0.7)" strokeWidth="1.5"/><line x1="20" y1="15" x2="24" y2="15" stroke="rgba(255,255,255,0.7)" strokeWidth="2"/>{!s&&<text x="22" y="52" textAnchor="middle" fontSize="5.5" fill="rgba(255,255,255,0.7)" fontWeight="bold">노예</text>}<text x="3" y="9" fontSize="7" fill="rgba(255,255,255,0.6)" fontWeight="bold">11</text><text x="41" y="58" fontSize="7" fill="rgba(255,255,255,0.6)" fontWeight="bold" transform="rotate(180,41,62)">11</text></svg>,
  12: (s) => <svg viewBox="0 0 44 64"><rect width="44" height="64" rx="4" fill="#1e293b"/><circle cx="15" cy="13" r="3" fill="rgba(255,255,255,0.3)" stroke="rgba(255,255,255,0.4)" strokeWidth="1"/><circle cx="29" cy="13" r="3" fill="rgba(255,255,255,0.3)" stroke="rgba(255,255,255,0.4)" strokeWidth="1"/><circle cx="22" cy="23" r="3" fill="rgba(255,255,255,0.3)" stroke="rgba(255,255,255,0.4)" strokeWidth="1"/><line x1="18" y1="13" x2="26" y2="13" stroke="rgba(255,255,255,0.4)" strokeWidth="1.5"/><line x1="17" y1="16" x2="20" y2="20" stroke="rgba(255,255,255,0.4)" strokeWidth="1.5"/><line x1="27" y1="16" x2="24" y2="20" stroke="rgba(255,255,255,0.4)" strokeWidth="1.5"/>{!s&&<text x="22" y="52" textAnchor="middle" fontSize="5.5" fill="rgba(255,255,255,0.4)" fontWeight="bold">대노예</text>}<text x="3" y="9" fontSize="7" fill="rgba(255,255,255,0.4)" fontWeight="bold">12</text><text x="41" y="58" fontSize="7" fill="rgba(255,255,255,0.4)" fontWeight="bold" transform="rotate(180,41,62)">12</text></svg>,
  joker: (s) => <svg viewBox="0 0 44 64"><defs><linearGradient id="gj" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#7c3aed"/><stop offset="100%" stopColor="#db2777"/></linearGradient></defs><rect width="44" height="64" rx="4" fill="url(#gj)"/><rect x="2" y="2" width="40" height="60" rx="3" fill="none" stroke="rgba(255,255,255,0.3)" strokeWidth="1"/><polygon points="22,6 26,16 37,16 28,23 31,34 22,27 13,34 16,23 7,16 18,16" fill="rgba(255,255,255,0.9)"/>{!s&&<text x="22" y="52" textAnchor="middle" fontSize="5.5" fill="rgba(255,255,255,0.9)" fontWeight="bold">어릿광대</text>}</svg>,
};
