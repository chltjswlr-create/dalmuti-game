...
//  8. 메인 화면
// ================================================================
function MainScreen({ onCreateRoom, onJoinRoom, loading }) {
...
function useFirebaseGame() {
  ...
  return {
    ...
    tributeCards, returnCards, readyForNext,
  };
}
...
export default function App() {
  ...
  if (screen === "main")
    return <MainScreen onCreateRoom={createRoom} onJoinRoom={joinRoom} loading={loading} />;
